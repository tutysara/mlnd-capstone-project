...
model_path = f'saved_models/all_layers_{arch}_weights.hdf5'
test_result = f'saved_models/{test_prefix}all_layers_{arch}_result.npz'
log_filename=f"result_predict_all_layer_train_{arch}_{d.year}-{d.month}-{d.day}-{d.hour}.{d.minute}.{d.second}_{test_prefix}.log"
...
log.debug("prediction for fine tune all layers")
